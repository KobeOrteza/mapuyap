        ...
        <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center my-auto">
          ...
          <div className="space-y-12 relative block w-full pr-0 md:pr-4">
            ...
            <div className="pt-4 relative block w-full max-w-lg space-y-3">
              ...
              <div className="relative block w-full pt-1 sm:pl-8">
                <button
                  onClick={() => handleFutureFeature("Course Q&A")}
                  className="w-full text-left bg-white text-black font-black border-4 border-black px-6 py-4 text-base md:text-lg shadow-[6px_6px_0px_0px_#D97706] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_0px_#D97706] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[4px_4px_0px_0px_#000] transition-all rounded-2xl flex items-center justify-between gap-4"
                >
                  <span>🎓 Q&A About Courses</span>
                  <span className="bg-[#D97706] text-white text-[10px] px-2 py-0.5 rounded-full font-mono tracking-wider font-bold whitespace-nowrap">
                    COMING SOON
                  </span>
                </button>
              </div>
          ...
          <div className="w-full bg-white border-4 border-black p-6 md:p-8 shadow-[8px_8px_0px_0px_#B91C1C] rounded-none relative block h-auto">
            ...
            <div className="flex flex-col gap-5 mb-5 relative block h-auto w-full">
              {/* Input Name */}
            ...
            <div className="border-4 border-black p-4 mb-5 bg-stone-50 font-mono text-xs space-y-2 shadow-[2px_2px_0px_0px_#000] relative block h-auto w-full">
              <div className="block">
            ...
            <div className="flex items-start gap-3 mb-6 relative h-auto w-full">
              <input
                type="checkbox"
                id="termsAgreement"
