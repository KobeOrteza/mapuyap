...
export default function RoomPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // Safety Fallback: Force users to sign in if data gets cleared out
      if (!storedName) {
        router.push("/");
        return;
      }
      ...
      setName(storedName);
      setDepartment(storedDept || "Unknown");
    }
  }, [router]);
  ...
  // FIX: Redirect back to the lobby page so matchmaking scripts execute automatically
